...
histogramContainer tau1_ptContainer{"tau1_pt","Sub-leading Tau pT",50,0,500,cutNames,"t1pt"};
histogramContainer tau0_ptContainer{"tau0_pt","Leading Tau pT",50,0,500,cutNames,"t0pt"};
histogramContainer n_bjetsContainer{"n_bjets","Number of b_jets",2,-0.5,1.5,cutNames,"nbj"};
...
histogramContainer rnn_score_3p_0Container{"rnn_score_3p_tau0","RNN Score 3 prong tau 0",40,0,1,cutNames,"rnn"};
histogramContainer rnn_score_1p_1Container{"rnn_score_1p_tau1","RNN Score 1 prong tau 1",40,0,1,cutNames,"rnn"};
histogramContainer rnn_score_3p_1Container{"rnn_score_3p_tau1","RNN Score 3 prong tau 1",40,0,1,cutNames,"rnn"};
